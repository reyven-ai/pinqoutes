        ...
        <div className="bg-secondary flex items-center justify-center w-[550px] h-screen flex-col">
          <div>
            ...
            <div className="flex-column text-center mt-4 gap-3 m-[auto] w-[460px]">
              <button
                type="button"
                className="w-[80%] m-[auto] justify-center flex py-2 px-0 border-[1px] border-socialButtonBorder socialButtonBorder rounded-[24px] mb-2"
              >
                <img
              ...
              <button
                type="button"
                className="w-[80%] m-[auto] flex py-2 px-0 border-[1px] border-socialButtonBorder socialButtonBorder justify-center rounded-[24px]"
              >
                <img
