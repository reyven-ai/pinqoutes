        ...
        <div className="bg-secondary flex items-center justify-center w-[550px] h-screen flex-col">
          <div>
            ...
            <div className="flex mt-4 gap-3 w-full mb-4 ml-16 mr-16">
              <button
                type="button"
                className=" w-3/12 flex py-2 px-0 border-[1px] socialButtonBorder justify-center rounded-[24px]"
              >
                <img
            ...
            <div>
              <p className="text-primaryTextColor text-[15px] text-center font-light my-[5px] mx-0">
